...
?>
    ...
    <body>
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid" style="margin-top: 80px; padding: 25px;">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="../home/homeOpeB.php" style="color: black; text-decoration: none;"><i class = "fas fa-arrow-left"> Volver</i></a>
                        </div>
                    </div>
        ...
        <script src="../../static/js/operadorB/listServReaOpeB.js"></script>
    </body>
    </html>
<?php
else :
