                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" id="formularioADDUsuario">
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" class="form-control" id="nom_uso_add" placeholder="Ingrese un nombre de usuario" name="nom_uso_add" minlength="3" maxlength="8" required>
                            </div>
                            <div class="mb-3 mt-3">
                                <label for="pwd_usu_add" class="form-label">Contraseña Usuario:</label>
                                <input type="password" class="form-control" id="pwd_usu_add" placeholder="Ingrese una contraseña" name="pwd_usu_add" minlength="3" maxlength="8" required>
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" id="formularioUpdateUsuario">
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" class="form-control" id="nombre_ope_up" placeholder="Ingrese el nombre del operador" name="nombre_ope_up" readonly>
                            </div>
                            <div class="mb-3 mt-3">
                                <label for="nom_usu_up" class="form-label">Nombre Usuario: </label>
                                <input type="text" class="form-control" id="nom_usu_up" placeholder="Ingrese el primer apellido del operador" name="nom_usu_up" required>
                            </div>
                            <div class="mb-3 mt-3">
                                <label for="pwd_usu_up" class="form-label">Contraseña Usuario: </label>
                                <input type="password" class="form-control" id="pwd_usu_up" placeholder="Ingrese el segundo apellido del operador" name="pwd_usu_up" required>
                            </div>
                            <div class="mb-3 mt-3">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" id="formularioDeleteUsuario">
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" class="form-control" id="nom_usu_de" placeholder="Ingrese el numero del saniatraio" name="nom_usu_de" readonly>
                            </div>
                            <div style="display: flex; justify-content: right;">
