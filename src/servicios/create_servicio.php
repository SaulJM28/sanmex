                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="row g-3" id="formularioADDServicio" method="post">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="ruta">Ruta <strong style="color: red;">*</strong></label>
                                                <select class="form-select" name="ruta" id="ruta">
                                                </select>
                                                <small>Al seleccionar la ruta se obtendra el operador</small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="CheckboxL" value="LUNES">
                                                    <label class="form-check-label" for="inlineCheckbox1">L</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="CheckboxM" value="MARTES">
                                                    <label class="form-check-label" for="inlineCheckbox1">M</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="CheckboxMI" value="MIERCOLES">
                                                    <label class="form-check-label" for="inlineCheckbox1">MI</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="CheckboxJ" value="JUEVES">
                                                    <label class="form-check-label" for="inlineCheckbox1">J</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="CheckboxV" value="VIERNES">
                                                    <label class="form-check-label" for="inlineCheckbox1">V</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="CheckboxS" value="SABADO">
                                                    <label class="form-check-label" for="inlineCheckbox1">S</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="CheckboxD" value="DOMINGO">
