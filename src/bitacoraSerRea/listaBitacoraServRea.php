...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div class="fondo__sidebar" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="../../src/bitacoraSerRea/listaBitacoraServRea.php" class="list-group-item list-group-item-action second-text fw-bold active">Bitacora de Servicios</a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div>
                                    ...
                                    <h1 style="text-align: center;">Bitacora de servicios realizados</h1>
                                </div>
                                <br>
                                <table id="tableBitRea" class="table table-striped  nowrap" style="width:100%;">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">Evidencia del servicio realizado</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>

                <!-- Modal body -->
                <div class="modal-body" id = "evidenciaSerReaBit">
                </div>
    ...
    <script src="../../static/js/bitacoraSerRea/bitacoraSerRea.js"></script>
