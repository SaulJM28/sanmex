            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid" style="margin-top: 80px; padding: 10px;">
                    <div class="row">
                                ...
                                <div class="card sombra">
                                    <div class="card-body">
                                        ...
                                        <div style="display: flex; justify-content: right;">
                                            <a href="../operadorA/listaServicios.php" class="btn btn-default"><i class="fas fa-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-md-4 mt-2 ">
                            <a href="../operadorA/listaSerRea.php" class="link__card">
                                <div class="card sombra">
                                    <div class="card-body">
                                        ...
                                        <div style="display: flex; justify-content: right;">
                                            <a href="../operadorA/listaSerRea.php" class="btn btn-default"><i class="fas fa-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </a>
