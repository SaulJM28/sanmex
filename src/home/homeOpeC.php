...
?>
    ...
    <body>
                ...
                <div class="container-fluid" style="margin-top: 80px; padding: 10px;">
                    <div class="row">
                        ...
                        <div class="col-md-4 mt-2 ">
                            <a href="../operadorC/listaServicios.php" class="link__card">
                                <div class="card sombra">
                                    <div class="card-body">
                                        ...
                                        <div style="display: flex; justify-content: right;">
                                            <a href="../operadorC/listaServicios.php" class="btn btn-default"><i class="fas fa-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-md-4 mt-2 ">
                            <a href="../operadorC/listaSerRea.php" class="link__card">
                                <div class="card sombra">
                                    <div class="card-body">
                                        ...
                                        <div style="display: flex; justify-content: right;">
                                            <a href="../operadorC/listaSerRea.php" class="btn btn-default"><i class="fas fa-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </a>
        ...
        <script src="../../static/js/operadorC/operadorC.js"></script>
    </body>
