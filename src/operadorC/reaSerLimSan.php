...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid" style="margin-top: 80px; padding: 10px;">
                <div class="row">
                    <div class="col-md-12" id="backUrl">
                        ...
                        <div class="card" style="width: 100%;">
                            <div class="card-body">
                                ...
                                <form  action="./back/insert_bit.php" id="formularioADDSerBit" method="POST" enctype="multipart/form-data">
                                        ...
                                        <input type="text" class="form-control" id="servicioSerRea" name="servicioSerRea">
                                        <input type="hidden" class="form-control" id="clienteSerRea" name="clienteSerRea">
                                        <input type="hidden" class="form-control" id="sanitarioSerRea" name="sanitarioSerRea">
                                        <input type="hidden" class="form-control" id="coordADD" name="coordADD">
                                    <div class="mb-3">
                                        <label for="comentarioSerRea" class="form-label">Comentario: </label>
                                        <textarea type="text" class="form-control" id="comentarioSerRea" name="comentarioSerRea" onkeyup="javascript:this.value=this.value.toUpperCase();"></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="fileEvidenciaSerRea" class="form-label">Evidencia: </label>
                                        <input type="file" capture="camera" class="form-control" id="fileEvidenciaSerRea" name="fileEvidenciaSerRea">
                                    </div>
    ...
    <script src="../../static/js/operadorC/reaSerLimSan.js"></script>
</body>
</html>
<?php 
else : 
