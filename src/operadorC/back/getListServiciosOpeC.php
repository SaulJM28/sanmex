...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $sql1 = $dbConn->prepare("SELECT COUNT(*) as TotalRegis FROM `servicio` S  LEFT JOIN rutas R ON S.id_rut = R.id_rut where R.id_ope = '$id_ope' AND S.estatus = 'ACTIVO'");
    $sql1->execute();
