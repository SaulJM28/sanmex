<?php
session_start();
if (isset($_SESSION['nom_usu']) && ($_SESSION['tip_usu'] == "ADMINISTRADOR" || $_SESSION['tip_usu'] == "EJECUTIVO VENTAS" || $_SESSION['tip_usu'] == "DIRECTOR" || $_SESSION['tip_usu'] == "GERENTE")) :
?>
    <!DOCTYPE html>
    <html lang="en">
    <head>
                    ...
                    <div class="row">
                        ...
                        ?>
                            <div class="col-md-4 mt-2 ">
                                <a href="./src/sanitarios/sanitariosDispo.php" class="link__card">
                                    <div class="card sombra">
                                        <div class="card-body">
                                            <img src="static/img/iconos/bano.png" class="img-fluid" loading="lazy" width="60" height="60">
                                            <h4 class="card-title">Disponibilidad de Sanitarios</h4>
                                            <p class="card-text">Módulo para ver los sanitarios disponibles</p>
                                            <div style="display: flex; justify-content: right;">
                                                <a href="./src/sanitarios/sanitariosDispo.php" class="btn btn-default"><i class="fas fa-arrow-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                        ...
                        <?php
                        if ($_SESSION['tip_usu'] == 'ADMINISTRADOR') :
                        ?>
                            <div class="col-md-4 mt-2 ">
                            ...
                            <!-- TIPOS DE SERVICIOS -->
                            <div class="col-md-4 mt-2 ">
                                <a href="./src/tiposServicios/tiposServicios.php" class="link__card">
                                    <div class="card sombra">
                                        <div class="card-body">
                                            <img src="static/img/iconos/self-service.png" class="img-fluid" loading="lazy" width="60" height="60">
                                            <h4 class="card-title">Tipos de Servicios</h4>
                                            <p class="card-text">Módulo para la gestión de tipos de servicos</p>
                                            <div style="display: flex; justify-content: right;">
                                                <a href="./src/tiposServicios/tiposServicios.php" class="btn btn-default"><i class="fas fa-arrow-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                        ...
                        <?php endif; ?>
                        <?php if ($_SESSION['tip_usu'] == "DIRECTOR" || $_SESSION['tip_usu'] == "GERENTE" || $_SESSION['tip_usu'] == "ADMINISTRADOR" ) : ?>
                            <div class="col-md-4 mt-2 ">
