                      ...
                      <div class="row g-0">
                          <div class="col-lg-6">
                              <div class="card-body p-md-5 mx-md-4">
                                  ...
                                  <div class="text-center">
                                      <img src="./static/img/logo_sanmex.webp" style="width: 185px;" loading="lazy" alt="logo_sanmex_login">
                                      ...
                                      <div class="mb-3 mt-3">
                                          <label for="nom_usu" class="form-label"><b>Nombre de usuario:</b></label>
                                              <div class="input-group">
                                                ...
                                                placeholder="Ingrese su nombre de usuario" name="nom_usu" maxlength="8">
                                              </div>
                                      </div>
                          ...
                          <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                              <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                  ...
                                  <p class="small mb-0" >Somos una empresa con más de 30 años de experiencia ofreciendo soluciones en ingeniería sanitaria. Tenemos presencia a nivel nacional en las ciudades más importantes de nuestro país.</p>
