define(["exports"], function (t) {
  ...
  const a = {
    ...
    h = (t) =>
      [a.prefix, t, a.suffix].filter((t) => t && t.length > 0).join("-"),
    u = (t) => t || h(a.precache),
    l = (t) => t || h(a.runtime);
  function f(t, e) {
    const s = e();
        ...
        f = l
          ? await (async function (t, e, s, n) {
              ...
              const r = Object.assign(Object.assign({}, n), {
                ...
                o = await t.keys(e, r);
              for (const e of o) if (i === R(e.url, s)) return t.match(e, n);
  ...
  class L {
    ...
    handleAll(t) {
      ...
      const e = t.event,
        ...
        i = new U(this, { event: e, request: s, params: n }),
        r = this.q(i, s, e);
        ...
        });
      {
        ...
        (n = await e.fetch(
          ...
          s &&
            o &&
            "no-cors" !== t.mode &&
            (this.N(), await e.cachePut(t, n.clone()));
      }
      return n;
    }
    async C(t, e) {
  ...
  class C {
    constructor({
      ...
      (this.k = new Map()),
        ...
        (this.l = new b({
          cacheName: u(t),
          plugins: [...e, new p({ precacheController: this })],
          fallbackToNetwork: s,
        })),
  ...
  function N(t) {
    ...
    !(function (t, e, n) {
      ...
      (c || ((c = new o()), c.addFetchListener(), c.addCacheListener()),
      c).registerRoute(a);
    })(new x(e, t));
  }
...
//# sourceMappingURL=workbox-8ec3ac40.js.map
