        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="fondo__sidebar" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush my-3">
                    <a href="servicio.php" class="list-group-item list-group-item-action active second-text">Realizar Servicio</a>
                    <a href="./src/serviciosRea/servicios_rea.php" class="list-group-item list-group-item-action second-text">Servicios Realizados</a>
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid" style="margin-top: 80px; padding: 25px;">
                    <div class="row">
                        <div class="col-md-12">
                            <p style="text-align: left;"><a href="home_ope.php">Inicio</a>/<a href="servicio.php">Realizar
                                    Servicio</a></p>
                        </div>
                    </div>
