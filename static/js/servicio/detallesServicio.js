...
const get_infoSanBySer = () =>{
  $.ajax({
    ...
    beforeSend: function () {},
    success: function (response) {
      let tamArrar =  response.length;
      let sans_rent = document.getElementById("num_sans").value;
      document.getElementById("tittleSanAsig").innerHTML = `Informacion de los sanitarios asignados ${tamArrar} de ${sans_rent}`;
      if(tamArrar >= sans_rent){
